...
import ModelStatus from "@/components/status/ModelStatus";
import CostTracker from "@/components/status/CostTracker";
  ...
  return (
    <main className="h-screen w-full bg-[#090d14] text-white">
      <div className="grid h-full grid-cols-12 gap-3 p-3">
        ...
        <div className="col-span-12 flex flex-wrap items-center gap-2 rounded-lg border border-white/10 bg-[#0b1220] px-3 py-2">
          <ModelStatus />
          <CostTracker />
        </div>
      </div>
