...
Coverage summary: {"allowWebResearch": true, "extractedCharRatio": 0.993, "extractedChars": 141472, "overallCoverage": 0.692, "sourceCount": 3, "sourceCoverageRatio": 0.75, "sourceDiversityRatio": 0.333, "uniqueDomains": 1}
Source inventory:
...
- Provider health manager with circuit breaker and retry budget
- Timeout budget by stage (retrieval, per-agent generation, final synthesis)
- Graceful degraded mode t | Autonomous research task.
Coverage summary: {"allowWebResearch": true, "extractedCharRatio": 0.993, "extractedChars": 141472, "overallCoverage": 0.692, "sourceCount": 3, "sourceCoverageRatio": 0.75, "sourceDiversityRatio": 0.333, "uniqueDomains": 1}
Source inventory:
- file:///home/Jit-Paul-2008/Desktop/Hexamind/src/docs/*.md
- file:///home/Jit-Paul-2008/Desktop/Hexamind/*.md
...
- Provider health manager with circuit breaker and retry budget
- Timeout budget by stage (retrieval, per-agent generation, final synthesis)
- Graceful degraded mode t' through a five-agent adversarial pipeline. Primary synthesis: Taken together, the evidence on 'Autonomous research task. Evidence base includes 0 retrieved sources; confidence is low.
